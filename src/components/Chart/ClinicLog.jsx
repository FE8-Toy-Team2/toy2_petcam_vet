...
const ClinicLog = () => {
  ...
  const updateChartData = async (id, newChartData) => {
    ...
    try {
      const dataToUpdate = {};
      if (newChartData.clinic_text !== undefined) dataToUpdate.clinic_text = newChartData.clinic_text;
      if (newChartData.age !== undefined) dataToUpdate.age = newChartData.age;
      if (newChartData.name !== undefined) dataToUpdate.name = newChartData.name;
      if (newChartData.sex !== undefined) dataToUpdate.sex = newChartData.sex;
      if (newChartData.species !== undefined) dataToUpdate.species = newChartData.species;
      if (newChartData.weight !== undefined) dataToUpdate.weight = newChartData.weight;
      if (newChartData.neutering !== undefined) dataToUpdate.neutering = newChartData.neutering;
      if (newChartData.guardian !== undefined) dataToUpdate.guardian = newChartData.guardian;
      if (newChartData.reservation_next !== undefined) dataToUpdate.reservation_next = newChartData.reservation_next;
      if (newChartData.admit_to_hospital !== undefined) dataToUpdate.admit_to_hospital = newChartData.admit_to_hospital;
      if (newChartData.admit_to_hospital_out !== undefined) dataToUpdate.admit_to_hospital_out = newChartData.admit_to_hospital_out;
      if (newChartData.admit_to_hospital_in !== undefined) dataToUpdate.admit_to_hospital_in = newChartData.admit_to_hospital_in;
